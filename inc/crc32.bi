...
'
Declare Function crc32(ByVal crc As uInteger, buf As ZString ptr, ByVal buf_len As Integer) As UInteger 
 'Dim crc As uInteger
 'Dim teststr As String

 '  teststr = "Hello"
 '  crc = 0
 '  crc = crc32(crc, strptr(teststr), Len(teststr))
 '  Print HEX$(crc)
 '  sleep
...
'::::::::::::::::
Public Function crc32(ByVal crc As uInteger, _
